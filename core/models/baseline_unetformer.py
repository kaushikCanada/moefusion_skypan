"""
UNetFormer baseline from GeoSeg (Wang et al., 2022).

Source: https://github.com/WangLibo1995/GeoSeg
Paper: "UNetFormer: A UNet-like Transformer for Efficient Semantic Segmentation"

Adapted: added in_channels support, unified output dict.
"""
...
class GlobalLocalAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        q, k, v = rearrange(
            ...
            hh=Hp // self.ws, ww=Wp // self.ws, qkv=3,
...
class Decoder(nn.Module):
    def __init__(self, encoder_channels=(64, 128, 256, 512),
                 decode_channels=64, dropout=0.1, window_size=8,
                 num_classes=6):
        super().__init__()
        ...
        # Aux head for deep supervision during training
...
class UNetFormer(nn.Module):
    def __init__(self, decode_channels=64, dropout=0.1,
                 backbone_name='swsl_resnet18', pretrained=True,
                 window_size=8, num_classes=6, in_channels=3):
        super().__init__()
        self.backbone = timm.create_model(
            backbone_name, features_only=True, output_stride=32,
...
# -- Wrapper for unified training interface -----------------------------------

class BaselineUNetFormer(nn.Module):
    """Wrapper that returns {'logits': ...} and handles aux loss."""

    def __init__(self, num_classes=7, in_channels=5, decode_channels=64,
                 backbone_name='swsl_resnet18', pretrained=True,
